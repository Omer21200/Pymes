    ...
    try {
      ...
      if (empresaId != null) {
        ...
        final recent =
            await Supabase.instance.client
                    .from('registros_asistencia')
                    .select('id,usuario_id,capturado_en,foto_url')
                    .eq('empresa_id', empresaId)
                    .order('capturado_en', ascending: false)
                    .limit(5)
                as List<dynamic>? ??
            [];
        ultimosRegistros = recent
            .map(
              (r) => {
                'id': r['id'],
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Administrador - ${widget.companyName ?? ''}',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MetricCard(
                        ...
                        value: notificacionesEnviadas.toString(),
                      ...
                      ...ultimosRegistros.map((r) {
                        ...
                        return RegistroItem(
                          usuarioId: r['usuario_id']?.toString() ?? 'Usuario',
                          timestamp: ts,
