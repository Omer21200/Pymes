...
class _AdminsListState extends State<AdminsList> {
  ...
  Future<void> _loadAdmins() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error al cargar admins: $e')));
      }
    }
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('Administradores', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                const SizedBox(height: 6),
                const Text('Lista completa de administradores registrados', style: TextStyle(color: Colors.black54)),
                ...
                Align(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () async {
                      final created = await Navigator.of(context).push(MaterialPageRoute(builder: (_) => const CreacionAdmis()));
                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text('No hay administradores registrados', style: TextStyle(color: Colors.grey.shade600)),
                          ],
                        ),
                      ),
                    ),
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: CircleAvatar(
                          ...
                          child: const Icon(Icons.person, color: Color(0xFFD92344)),
                        ),
                        title: Text(fullName, style: const TextStyle(fontWeight: FontWeight.bold)),
                        subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Empresa: $empresaNombre'), Text('Rol: ${admin['rol']}')]),
