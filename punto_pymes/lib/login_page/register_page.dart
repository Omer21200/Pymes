...
class RegisterPage extends StatefulWidget {
  ...
  const RegisterPage({this.selectedInstitution = '', super.key});
    ...
    try {
      ...
      try {
        ...
        if (signUpResp.user != null) {
          authUser = {'id': signUpResp.user!.id};
        }
      } catch (e) {
      ...
      // columnas: id, empresa_id, nombre_completo, email, contrasena_hash, rol, telefono, avatar_url, estado
      // Hashear la contraseña con SHA256 y guardarla en la columna contrasena_hash
      final hashed = sha256.convert(utf8.encode(password)).toString();

      final userInsert = {
        if (authUser != null && authUser['id'] != null) 'id': authUser['id'],
        if (empresaId != null) 'empresa_id': empresaId,
        'nombre_completo': '$nombre ${apellido.isNotEmpty ? apellido : ''}'
            .trim(),
        'email': email,
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  widget.selectedInstitution.isNotEmpty
